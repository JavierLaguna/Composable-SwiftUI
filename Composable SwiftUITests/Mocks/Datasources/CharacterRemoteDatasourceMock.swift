...
struct CharacterRemoteDatasourceMock: CharacterRemoteDatasource {
    ...
    var expectedResponseByPage: GetCharactersResponse = GetCharactersResponse(
        ...
        results: [
            CharacterResponse(id: 1, name: "Rick", status: "alive", species: "", type: "", gender: "male", origin: CharacterLocationResponse(name: "earth", url: "urlLocation"), location: CharacterLocationResponse(name: "earth", url: "urlLocation"), image: "image", episode: ["url/1", "url/2"], created: "created")
        ]
    )
    var expectedResponseByIds: [CharacterResponse] = [
        CharacterResponse(id: 1, name: "Rick", status: "alive", species: "", type: "", gender: "male", origin: CharacterLocationResponse(name: "earth", url: "urlLocation"), location: CharacterLocationResponse(name: "earth", url: "urlLocation"), image: "image", episode: ["url/1", "url/2"], created: "created"),
        CharacterResponse(id: 2, name: "Morty", status: "alive", species: "", type: "", gender: "male", origin: CharacterLocationResponse(name: "earth", url: "urlLocation"), location: CharacterLocationResponse(name: "earth", url: "urlLocation"), image: "image", episode: ["url/1", "url/2"], created: "created")
    ]
