protocol GetEpisodeDescriptionInteractor: Sendable {
    func execute(episode: Episode) async throws -> String
}

struct GetEpisodeDescriptionInteractorFactory {

    static func build() -> any GetEpisodeDescriptionInteractor {
        GetEpisodeDescriptionInteractorDefault()
    }
}

struct GetEpisodeDescriptionInteractorDefault: GetEpisodeDescriptionInteractor, ManagedErrorInteractor {
